...
namespace acervoMusical
{
    ...
    public partial class Principal : Form
    {
        ...
        {
            FormCadMidia cadastroMidia = new FormCadMidia();
            ...
            if (listViewPesquisa.SelectedItems.Count == 1)
            {
                ...
                else
                {
                    if (listViewPesquisa.SelectedItems.Count == 1)
                    {
                        ...
                        {
                            FormEmprestimo emprestarMidia = new FormEmprestimo(idAlbum);
        ...
        public void AlterarAlbum(int alterar)
        {
            ...
            if (alterar == 0)
            {
                ...
                {
                    int idAlbum = int.Parse(listViewPesquisa.SelectedItems[0].Text);
                    FormEditaMidia alterarMidia = new FormEditaMidia(idAlbum, 0);
            ...
            else
            {
                ...
                {
                    int idAlbum = int.Parse(listViewPesquisa.SelectedItems[0].Text);
                    FormEditaMidia alterarMidia = new FormEditaMidia(idAlbum, 1);
