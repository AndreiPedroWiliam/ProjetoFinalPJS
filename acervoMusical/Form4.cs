            ...
            else
            {
                ...
                try
                {
                    if (conexao != null && conexao.State == ConnectionState.Open)
                    {
                        ...
                        inserirPessoa.CommandText = "INSERT INTO Pessoa (Nome, Telefone, Email, Logradouro, Numero, Bairro, Cidade, UF) VALUES('" + textBoxNomeCad.Text + "','" + maskedTextBoxTelefoneCad.Text + "','" + textBoxEmailCad.Text + "','" + textBoxLogradouroCad + "','" + textBoxNumeroCad.Text + "','" + textBoxBairroCad.Text + "','" + textBoxCidadeCad.Text + "','" + comboBoxCadUF.Text + "')";
